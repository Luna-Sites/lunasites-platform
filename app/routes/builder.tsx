...
} from "../components/wizard/WizardStep2";
...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Create Your Website - Luna Sites" },
    {
      name: "description",
      content:
        "Build your dream website with Luna Sites simple website builder.",
    },
  ];
}
...
export default function Builder() {
  ...
  const [selectedTemplateSiteId, setSelectedTemplateSiteId] = useState<
    string | null
  >(null);
  ...
  const [selectedInputStyle, setSelectedInputStyle] =
    useState<string>("rounded");
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 2:
        return true; // Allow proceeding even without style selections
      case 3:
        return siteTitle.trim() !== "" && siteId.trim() !== "" && !siteIdError;
      case 4:
        if (isCreatingAccount) {
          return (
            firstName.trim() !== "" &&
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-blue-50/30">
      ...
      {step > 1 && (
        <div className="min-h-screen flex flex-col">
          {/* Progress Bar for Step 2 only - Centered on Full Width */}
          {step === 2 && (
          ...
          {/* Two Column Layout */}
          <div className="flex-1 grid lg:grid-cols-[70%_30%]">
            {/* Left Panel - Form/Content */}
            <div className={`flex flex-col overflow-y-auto ${step === 2 ? 'p-8 lg:p-16 lg:pt-0' : 'p-8 lg:p-16'}`}>
              {/* Progress Bar for Steps 3+ - Inside Left Column */}
              {step >= 3 && (
